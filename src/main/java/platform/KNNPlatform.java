 ...
 * concurrently using OS-mapped platform threads to find the nearest neighbors.
 */
public class KNNPlatform {
     ...
     * Computes file positions, spawns platform threads, waits for completion, merges
